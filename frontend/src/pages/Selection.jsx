...
import { FileText, Sparkles, Syringe, Activity, Skull, ArrowRight, Zap, BrainCircuit } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      ...
      <div className="relative overflow-hidden">
        ...
        <main className="container relative mx-auto px-4 py-12 md:px-8">
          ...
          {/* Footer Logo */}
          <div className={`mt-16 mb-12 flex justify-center ${mounted ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '900ms' }}>
